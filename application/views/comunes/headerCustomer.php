...
<div id="headerMenu">
    ...
    if (($this->providerUriName != DOMAIN_NAME) && ($page != 'register')) {
        ?>
                    <!--a href="<?php //echo site_url('register')    ?>"><input type="button" id="button" value="Crear cuenta"/></a>
                    <a href="<?php //echo site_url('changePassword')    ?>"><input type="button" id="button" value="Cambiar contraseña"/></a-->
        <br>
        <div id="userOptions">
            <div id="buttonUser">
            ...
            <div id="userMenu" class="last ui-widget ui-widget-content ui-corner-all">
                ...
                <div style="background-color: #ddd; height: 60px">
                    <br>
                    &nbsp;&nbsp;
                    <a href="<?php echo site_url('contact') ?>"><input type="button" class="button" value="Contactar"/></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
